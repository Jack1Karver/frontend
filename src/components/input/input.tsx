    ...
    <>
      {props.type !== 'checkbox' ? (
        <div className={styles.input__field}>
          {props.title ? (
            <h5
              className={`${styles.input__title} ${props.titleType ? styles[`input__title--${props.titleType}`] : ''} ${
                props.disabled ? styles['input__title--disabled'] : ''
              }`}
            >
              {props.title}
            </h5>
          ...
          <input
            ...
            } ${props.margin ? styles[`input--${props.margin}`] : ''}`}
            type={props.type}
        ...
        <div className={styles.input__checkbox}>
          <input
            className={`${styles.input} ${props.disabled ? styles['input--disabled'] : ''}`}
